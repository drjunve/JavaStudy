...
class PersonalInfoDTO {
	...
	//생성자
	protected PersonalInfoDTO(String name, String juminNum) {
		super();
		this.name = name;
		this.juminNum = juminNum;
	}
	/* getter/setter : DTO객체에서 private으로
	선언된 멤버변수의 값을 성정하거나 반환할 때 사용한다. */
	public String getName() {return name;}
	public String getJuminNum() {return juminNum;}
	public void setName(String name) {this.name = name;}
	public void setJuminNum(String juminNum) {this.juminNum = juminNum;}
}
/* 제공된 추상클래스를 상속하여 한 사람의 정보를 저장하는 기능과 검색하는 기능을
 * 구현한 클래스 */
