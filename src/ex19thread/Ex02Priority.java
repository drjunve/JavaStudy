...
public class Ex02Priority {
	...
	public static void main(String[] args) {
		...
		동일한 우선순위 5를 부여받게된다. 이때는 CPU가 알아서 작업을 분배한다.
		 */
...
//		MessageSendingThread tr3 = new MessageSendingThread("세번째");
		...
		/*
		2단계 실행
		: Thread클래스의 정적상수를 이용해서 우선순위를 부여한다. 순서대로 10, 5, 1의 우선순위를
		부여하게 된다. 상수 대신 정수로 부여해도 된다.
		 */
...
//^ sleep를 없애면 조금 더 우선순위에 맞게 출력될지 실햄해보기