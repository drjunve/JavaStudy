...
class Singer {
	 ...
	 * 메서드이다. Java에서 정의하는 모든 클래스는 Object 클래스를 상속하므로
	 * 이와 같이 오버라이딩이 가능하다. */
	@Override
...
public class E02AnonymousClass {
	...
	public static void main(String[] args) {
		...
		생성해서 그 주소값을 할당한다.
		개념적으로 new GirlGrouup(){}; => 익명 extends GirlGroup 과 동일하다.
		...
		*/
		 ...
		 * 따라서 아래와 같이 자식에서 확장한 멤버변수는 접근할 수 없어 에러가
		 * 발생한다. 접근하고 싶다면 다운캐스팅(강제형변환)을 해야하지만
