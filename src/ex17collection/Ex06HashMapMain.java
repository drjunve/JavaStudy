...
public class Ex06HashMapMain {
	...
	public static void main(String[] args) {
		...
		/*
		키값을 모를 때(혹은 키값이 너무 많아서 하나씩 명시하기 힘들 때)
		...
		/*
			3. 이터레이터를 통한 출력
			: 이터레이터를 통해 출력할 때도 keySet()을 통해 key를
			먼저 얻어온 후 반복 출력한다.
		 */
		...
		/*
		Value만 얻어와야 할 때
		: value만 얻어올 때는 values() 메서드를 통해 값을 추출할 수 있다.
