...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		list.add("트와이스");
		list.add(3,"워너원");
//		list.add(5,"소방차ㅋㅋ"); //에러발생됨(^인덱스를 할당할 때마다 인덱스 크기가 결정되는데, 건너뛰면 안됨)
		/*
		...
		방법3 : Iterator 사용
			...
			인스턴스를 생성한다.
			2) hasNext()로 출력할 인스턴스가 있는지 검사한다. 만약 인스턴스가
			더이상 없다면 false를 반환한다.
		...
		System.out.print("빅뱅의 index="+index);
		list.remove(index);
		 ...
		 */
		System.out.println(list.remove("방탄소년단") ? "삭제성공(방탄)" : "삭제실패(마이걸)");
		//객체가 없으므로 삭제에 실패한다.
