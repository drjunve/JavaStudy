...
class MyString implements Comparable<MyString> {
	...
	/*
	TreeSet<T>에 객체를 저장할 때 정렬을 위해 compareTo()메서드를 오버라이딩한다. 정렬의 기준은
	단순하게 가나다라와 같은 순서가 될 수도 있고, 문자열의 길이에 따른 정렬이 될 수도 있다.
...
public class Ex05TreeSetMain {
	...
	public static void main(String[] args) {
		...
		/* Java에서 제공하는 기본 클래스인 경우 별도의 오버라이딩을 하지 않아도 된다. */
