...
/*
break문 : 반복문이 switch문에서 주로 사용되며 블럭내에서 탈출할 때 사용한다. 만약 중첩된
반복문이라면 가장 가까운 블럭 하나만 탈출한다.
continue문 : 반복문의 처음으로 돌아간다. while문의 경우 조건을 확인하고 for문의 경우
증감식이 실행된다. 따라서 continue 아래 문장은 실행되지 않는다.
 */
public class E06BreakContinue {
	...
	public static void main(String[] args) {
		...
		while(true) {
			/*
			반복문 내에서 break, continue문은 사용할 때는 반드시 조건문과 같이 사용해야한다.
