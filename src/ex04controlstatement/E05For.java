...
public class E05For {
	...
	public static void main(String[] args) {
		...
		for(int i=1 ; i<=10; i++) {
			...
			/*
			for문의 끝에 ;을 사용하면 반복할 문장이 없는 것으로
			...
			메모리에서 소멸된다. 여기서 사용된 변수 j는
			지역변수(Local variable)라고 한다.
			...
			해당변수는 for문의 안쪽(좁은 지역)에서 사용할 수 있다.
			즉, 아래에 선언한 변수 i는 main메서드의 지역변수로 선언된다.
			 */
			/*
			 * int i=0; for( ; i<=5 ; i++) { System.out.println("for문 안에서의 i값="+i); }
			 * System.out.println("for문 밖에서의 i값="+i);
			 */
			/* Java에서는 중괄호가 나오면 하나의 지역이라 생각하면 된다. 즉 if문,
			while문 등의 제어문도 지역을 가지게 된다. */
