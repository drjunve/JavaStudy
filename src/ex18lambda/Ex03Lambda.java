...
/*
 * 3.람다식으로 구현하기
 * : 객체지향 프로그래밍에서는 메서드를 선언하기 위해 반드시 클래스를 정의해야한다. 이러한 불편함 때문에 함수형 프로그래밍(Functional Programming)의 장점이 대두되었고, 이런 Java문법의 단점을 보완하기 위해 JDK1.8부터 람다식을 지원하게 되었다.
 */
...
public class Ex03Lambda {
	...
	1. 함수명을 제거한다. 어차피 부모 인터페이스로부터 오버라이딩했으므로
	동일한 이름인 것을 우리는 알고 있다.
	2. 람다식임을 포현하기 위해 소괄호와 중괄호 사이에 화살표를 삽입한다.
	좌측의 부모참조변수가 우측의 자식영영을 참조한다는 개념으로 이해하면 된다.
	 */
	public static void main(String[] args) {
		...
		유추할 수 있으므로 String을 제거할 수 있다. 또한 실행문이 하나인
		경우에는 중괄호도 생략할 수 있다.
		 */
