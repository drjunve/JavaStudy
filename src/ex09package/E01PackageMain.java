...
/* 임포트 선언부 : 현재 작성중인 클래스에서 다른 패키지에 있는 클래스를 가져다
 * 쓰기 위한 선언으로, 사용할 클래스의 위치를 지정하는 것으로 생각하면 된다. */
...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		 ...
		 * 방법2 : 하나의 클래스는 import 하고, 다른 하나는 풀 패키지 경로를
		 * 기술한다. */
		 ...
		 * 난수 생성을 위해 별도의 인스턴스 생성없이 Math.random()을 통해
		 * 난수를 생성한다. */
