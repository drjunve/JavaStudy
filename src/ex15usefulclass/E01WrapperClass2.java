...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) { 
		 ...
		 */
		String money = "120원";
		//↓ 자바스크립트에서는 "120원"에서 원을 제외 120만 출력되지만,("원120"은 자바스크립트에서도 안됨)
		// 자바에서는 "120"만 가능하다.
...
//		System.out.println("공백갯수:"+whiteCnt);
		...
		///내코드 시작
		int spaceNum =0;
		char[] tarString = whiteString.toCharArray();
		for(int i=0 ; i<=tarString.length-1 ; i++) {
			if(Character.isWhitespace(tarString[i])) {
				spaceNum++;
			}
		}
		System.out.println("총공백수:"+spaceNum);
		////내코드 끝
	}
