...
public class E01OneDimArray02 {
	...
	public static void main(String[] args) {
		...
		/*
		난수 생성 방법2
		: Random 클래스를 사용한다. 사용법은 Scanner와 동일하게 정수형 난수를
		...
		for(int i=0 ; i<lottoNum.length ; i++) {
			...
			/* lottoNum[i] = (int)(Math.random()*45)+1; => 이것도 가능.
			0~1사이의 숫자에 45를 곱하면 0과 45에 한없이 가까운 숫자들이 나오게 된다.*/ 
		}
		//배열을 출력한다.
		for(int i = 0 ; i<lottoNum.length ; i++) {
