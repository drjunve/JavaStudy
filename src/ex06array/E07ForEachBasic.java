...
/*
foreach문(개선된 for문)
: 배열의 일부가 아니라 전체를 참고해야할 떄 주로 사용하는 for문을 말한다.
배열의 원소를 참조의 형태로 가져와서 사용한다. 따라서 참조의 목적으로만 사
용해야하고, 값의 변경은 허용하지 않는다.
...
public class E07ForEachBasic {
	...
	public static void main(String[] args) {
		...
		통해 증가시킨 값은 실제 배열에 적용되지 않는다. 해당 for문 내에서만 증가된 값이
		출력된다. */
