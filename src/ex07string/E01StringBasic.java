...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/* 기본자료형의 경우 비교연산자 ==을 통해 값에 대한 비교를 한다. 변수에
		 * 값이 할당되어 있으므로 아래와 같이 비교할 수 있다. */
		int num1=10, num2=20;
		...
		실제 저장된 문자열을 비교하도록 만들어져있다. 즉, 아래는 객체에 저장된
		...
		: 더블 쿼테이션을 사용한다. 이 경우 내용이 동일하다면 같은 주소를 사용한다.
		즉, 새로운 메모리를 할당하지 않는다. 따라서 String 객체는 주로 방법2를
		통해 사용하는 것이 좋다.*/
		String str3 = "자바개발자";
		String str4 = "자바개발자";
