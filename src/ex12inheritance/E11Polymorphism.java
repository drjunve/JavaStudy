...
class Child extends Parent{
	...
	//부모에서 정의한 메서드를 오버라이딩 해서 재정의한 메소드
	@Override
	void parentMethod() {
		System.out.println("자식에서 Overriding한 메소드" + "parentMethod()");
	}
	/* 메서드명은 동일하지만 매개변수가 틀리므로 오버로딩으로 정의된 메서드이다. 따라서 자식에서 확장한 멤버가 된다. */
...
public class E11Polymorphism {
	...
	public static void main(String[] args) {
		...
		//부모 타입으로 자식 인스턴스에 접근할 수 없으므로 에러발생
//		parent1.childMember = 1;
		 ...
		 * (Child)parent2.childMember //에러 발생함. child(parent2.childMember)와 같은 결과가 나옴.
